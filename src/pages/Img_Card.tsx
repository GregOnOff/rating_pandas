        ...
        <div className='grid grid-cols-2'>
            {cardData?.map((panda) => {
                return (
                    ...
                    {isInEditMode.includes(panda.id) ?  (<div>
                        ...
                        <button className='bg-red-500 p-2 rounded-xl ' onClick={() => closeEditForm(panda.id)}>cancel</button>
                        <button className='bg-red-500 p-2 rounded-xl ' type={'submit'}>save</button>
                        </div>
                    </div>) :(
                                <div>
                                    <button className='bg-red-500 p-4 rounded-xl ' onClick={() => openEditForm(panda.id)}>Edit</button>
                                <p>ID: {panda.id}</p>
